      ...
      <SideMenu menu={menu} menuPosition={'right'} isOpen={ this.state.isOpen } >
          ...
          <View style ={ styles.container2}>
            ...
            <View style={ styles.container1 }>
              <Profile hideSideMenu= {this.hideSideMenu.bind(this)} name= {this.props.name} bio={this.props.bio} email={this.props.email} gender={this.props.gender} birthday={this.props.birthday} picture={this.props.picture} />
            </View>
          </View>
      </SideMenu>
    );
